...
/**
 * Portfolio Custom Post Type -start
 *
 * @return void
 */
...
function register_portfolio_post_type() {
	$labels = array(
		...
		'set_featured_image' => 'Add Portfolio Thumbnail',
	);
...
/* Portfolio Custom Post Type -end*/